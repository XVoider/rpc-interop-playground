...
extern const MIDL_SERVER_INFO playground_interface_ServerInfo;

extern const RPC_DISPATCH_TABLE playground_interface_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE playground_interface___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x8680233F,0x63F1,0x489B,{0x80,0xA5,0x1E,0x69,0x46,0x8D,0xF6,0x4A}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&playground_interface_v1_0_DispatchTable,
    0,
    0,
    0,
    &playground_interface_ServerInfo,
    0x06000000
    };
RPC_IF_HANDLE s_playground_interface_v1_0_s_ifspec = (RPC_IF_HANDLE)& playground_interface___RpcServerInterface;
#ifdef __cplusplus
namespace {
#endif
...
static const RPC_DISPATCH_FUNCTION playground_interface_table[] =
    {
    NdrServerCall2,
    0
    };
static const RPC_DISPATCH_TABLE playground_interface_v1_0_DispatchTable = 
    {
    1,
    (RPC_DISPATCH_FUNCTION*)playground_interface_table
    };
...
static const MIDL_STUB_DESC playground_interface_StubDesc = 
    {
    (void *)& playground_interface___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& playground_interface_ServerInfo,   /* proxy/server info */
    0
    };
#ifdef __cplusplus
}
...
static const RPC_DISPATCH_FUNCTION playground_interface_NDR64__table[] =
    {
    NdrServerCallAll,
    0
    };
static const RPC_DISPATCH_TABLE playground_interface_NDR64__v1_0_DispatchTable = 
    {
    1,
    (RPC_DISPATCH_FUNCTION*)playground_interface_NDR64__table
    };
...
static const MIDL_SYNTAX_INFO playground_interface_SyntaxInfo [  2 ] = 
    ...
    ,{
    {{0x71710533,0xbeba,0x4937,{0x83,0x19,0xb5,0xdb,0xef,0x9c,0xcc,0x36}},{1,0}},
    (RPC_DISPATCH_TABLE*)&playground_interface_NDR64__v1_0_DispatchTable,
    0 ,
...
static const SERVER_ROUTINE playground_interface_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)s_pass_and_get_string
    };

static const MIDL_SERVER_INFO playground_interface_ServerInfo = 
    {
    &playground_interface_StubDesc,
    playground_interface_ServerRoutineTable,
    playground_interface__MIDL_ProcFormatString.Format,
    (unsigned short *) playground_interface_FormatStringOffsetTable,
    0,
